                ...
                <div class="container">
                    <div class="col-md-12 text-center mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <strong  style="font-size:18px;"> <img src="{{asset('assets/frontend/images/logo.gif')}}" alt="" style="width:100%;"></strong>
                            </div>
                            <div class="col-md-4">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="left">{{ $courierProductInfo->courier_info->name }}</td>
                                    <td class="right">{{ $courierProductInfo->created_at->toDateTimeString() }}</td>
                                    <td class="right">{{ $courierProductInfo->courier_quantity }}&nbsp; </td>
