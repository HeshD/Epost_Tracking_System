...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('general_settings')->insert([
            'title' => 'Welcome|SL Post',
            'header_title' => 'Epost',
            'header_subtitle' => 'Epost is a Branch based postal management system. Letter or Parcel Sender will send from a branch  or can be send from being at home. Receiver will receive from destination post office and will be deliver to their door step by postman !',
            'service_title' => 'What you can do with the system',
